...
REM ==========================================
REM ArcaneAudio clean rebuild (Windows)
REM ==========================================
...
REM Kill python processes that launched gmsnipe (more precise than killing all python)
powershell -NoProfile -Command ^
 "Get-CimInstance Win32_Process | Where-Object { ($_.Name -in 'python.exe','pythonw.exe') -and ($_.CommandLine -match 'gmsnipe') } | ForEach-Object { Stop-Process -Id $_.ProcessId -Force }" >NUL 2>&1
...
if exist "dist\ArcaneAudio"  rmdir /S /Q "dist\ArcaneAudio"
...
echo [✓] Build complete: dist\ArcaneAudio\
popd
endlocal